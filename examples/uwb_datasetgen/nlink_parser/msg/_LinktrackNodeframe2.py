...
float32 rx_rssi
"""
    __slots__ = ['role', 'id', 'stamp', 'local_time', 'system_time', 'voltage', 'pos_3d',
                 'eop_3d', 'vel_3d', 'angle_3d', 'quaternion', 'imu_gyro_3d', 'imu_acc_3d', 'nodes']
    _slot_types = ['uint8', 'uint8', 'time', 'uint32', 'uint32', 'float32', 'float32[3]', 'float32[3]',
                   'float32[3]', 'float32[3]', 'float32[4]', 'float32[3]', 'float32[3]', 'nlink_parser/LinktrackNode2[]']
    ...
    def serialize(self, buff):
        ...
        try:
            _x = self
            buff.write(_get_struct_2B4If().pack(_x.role, _x.id, _x.stamp.secs,
                       _x.stamp.nsecs, _x.local_time, _x.system_time, _x.voltage))
            ...
            for val1 in self.nodes:
                _x = val1
                buff.write(_get_struct_2B3f().pack(
                    _x.role, _x.id, _x.dis, _x.fp_rssi, _x.rx_rssi))
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            (_x.role, _x.id, _x.stamp.secs, _x.stamp.nsecs, _x.local_time,
             _x.system_time, _x.voltage,) = _get_struct_2B4If().unpack(str[start:end])
            start = end
            end += 12
            ...
            for i in range(0, length):
                ...
                (_x.role, _x.id, _x.dis, _x.fp_rssi, _x.rx_rssi,
                 ) = _get_struct_2B3f().unpack(str[start:end])
    ...
    def deserialize_numpy(self, str, numpy):
        ...
        try:
            ...
            self.pos_3d = numpy.frombuffer(
                str[start:end], dtype=numpy.float32, count=3)
            start = end
            end += 12
            self.eop_3d = numpy.frombuffer(
                str[start:end], dtype=numpy.float32, count=3)
            start = end
            end += 12
            self.vel_3d = numpy.frombuffer(
                str[start:end], dtype=numpy.float32, count=3)
            start = end
            end += 12
            self.angle_3d = numpy.frombuffer(
                str[start:end], dtype=numpy.float32, count=3)
            start = end
            end += 16
            self.quaternion = numpy.frombuffer(
                str[start:end], dtype=numpy.float32, count=4)
            start = end
            end += 12
            self.imu_gyro_3d = numpy.frombuffer(
                str[start:end], dtype=numpy.float32, count=3)
            start = end
            end += 12
            self.imu_acc_3d = numpy.frombuffer(
                str[start:end], dtype=numpy.float32, count=3)
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
